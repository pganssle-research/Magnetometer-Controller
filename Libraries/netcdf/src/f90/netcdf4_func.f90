  ...
  ! -----------  
  function nf90_put_vlen_element_FourByteInt_1D(ncid, xtype, vlen_element, len, data)
    integer, intent(in) :: ncid
    integer, intent(in) :: xtype
    integer, dimension(:), intent(in) :: vlen_element
    integer, intent(in) :: len
    integer, dimension(:), intent(in) :: data
    integer :: nf90_put_vlen_element_FourByteInt_1D
    nf90_put_vlen_element_FourByteInt_1D=nf_put_vlen_element(ncid,xtype,vlen_element,len,data)
  end function nf90_put_vlen_element_FourByteInt_1D
  ! -----------  
  function nf90_get_vlen_element_FourByteInt_1D(ncid, xtype, vlen_element, len, data)
    integer, intent(in) :: ncid
    integer, intent(in) :: xtype
    integer, dimension(:), intent(in) :: vlen_element
    integer, intent(out) :: len
    integer, dimension(:), intent(out) :: data
    integer :: nf90_get_vlen_element_FourByteInt_1D, res
    res=-99999
    len=-1
!    res=nf_get_vlen_element(ncid,xtype,vlen_element,len,data)
    nf90_get_vlen_element_FourByteInt_1D=res
  end function nf90_get_vlen_element_FourByteInt_1D
  ! -----------
...
!   ! -----------
  ...
  ! -----------
  function nf90_put_att_any_text(ncid, varid, name, typeid, length, values)
    integer,                          intent( in) :: ncid, varid
    character(len = *),               intent( in) :: name
    integer,                          intent( in) :: typeid, length
    character(len = *),               intent( in) :: values
    integer                                       :: nf90_put_att_any_text

    nf90_put_att_any_text = nf_put_att_any_text(ncid, varid, name, typeid, length, values)
  end function nf90_put_att_any_text
  ! -----------
  function nf90_put_att_any_FourByteInt_1D(ncid, varid, name, typeid, length, values)
    integer,                          intent( in) :: ncid, varid
    character(len = *),               intent( in) :: name
    integer,                          intent( in) :: typeid, length
    integer, dimension(:),            intent( in) :: values
    integer                                       :: nf90_put_att_any_FourByteInt_1D

    nf90_put_att_any_FourByteInt_1D = nf_put_att(ncid, varid, name, typeid, length, values)
  end function nf90_put_att_any_FourByteInt_1D
  ! -----------
  function nf90_get_att_any_text(ncid, varid, name, length, values)
    integer,                          intent( in) :: ncid, varid
    character(len = *),               intent( in) :: name
    integer,                          intent( in) :: length
    character(len = *),               intent( in) :: values
    integer                                       :: nf90_get_att_any_text

    nf90_get_att_any_text = nf_get_att_text(ncid, varid, name, values)
  end function nf90_get_att_any_text
  ! -----------
  function nf90_get_att_any(ncid, varid, name, length, values)
    ...
    nf90_get_att_any = nf_get_att_text(ncid, varid, name, values)
